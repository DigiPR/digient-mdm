...
import rocks.process.digient.mdm.channel.ConsumerChannel;
...
public class MessageListener {
    ...
    @StreamListener(target = ConsumerChannel.MDM, condition = "headers['type']=='customer'")
    @Transactional
    ...
    @StreamListener(target = ConsumerChannel.MDM, condition = "headers['type']=='application'")
    @Transactional
    ...
    @StreamListener(target = ConsumerChannel.MDM, condition = "headers['type']=='policy'")
    @Transactional
    ...
    @StreamListener(target = ConsumerChannel.MDM, condition = "headers['type']=='billing'")
    @Transactional
    ...
    @StreamListener(target = ConsumerChannel.MDM)
