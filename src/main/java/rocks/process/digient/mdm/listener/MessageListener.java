...
public class MessageListener {
    ...
    @Transactional
    public void customerMessage(@Payload Message<Customer> customerMessage) throws Exception {
    ...
    @Transactional
    public void applicationMessage(@Payload Message<Application> applicationMessage) throws Exception {
    ...
    @Transactional
    public void policyMessage(@Payload Message<Policy> policyMessage) throws Exception {
